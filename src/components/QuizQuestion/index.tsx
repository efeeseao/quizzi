...
const QuizQuestion = ({
  ...
  const [buttonText, setButtonText] = useState<string>("Enviar resposta");
  ...
  const submitAnswer = () => {
    ...
    setButtonText("Próxima pergunta");
